    ...
    <div className="max-w-7xl mx-auto space-y-8 pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
        <div>
          ...
          <h1 className="text-3xl font-black tracking-tight text-gray-900">Dashboard de Ventas & Gestión</h1>
          <p className="text-sm text-gray-500">
            Monitoreo en tiempo real de ingresos, productos líderes, inventario y catálogo.
          </p>
        </div>
      ...
      {/* GRÁFICO DE TENDENCIA DE VENTAS (ÚLTIMOS 30 DÍAS) */}
      <div className="bg-white p-6 md:p-8 rounded-xl border border-gray-200 shadow-sm">
        ...
        <div className="h-48 flex items-end gap-1.5 pt-6 pb-2 border-b border-gray-100">
          {metricas.tendenciaVentas.map((dia) => {
      ...
      {/* SECCIÓN DOBLE: PRODUCTOS MÁS VENDIDOS Y ALERTAS DE INVENTARIO */}
      ...
      {/* MÓDULOS DE GESTIÓN Y ACCESO RÁPIDO */}
      <div className="space-y-4 pt-2">
        <h2 className="text-lg font-bold text-gray-900">Módulos Administrativos</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <Link
            to="/admin/productos"
            className="p-4 bg-white rounded-xl border border-gray-200 hover:border-black hover:shadow-md transition-all group flex flex-col justify-between"
          >
            <div className="p-2.5 w-fit bg-gray-100 rounded-lg text-gray-800 group-hover:bg-black group-hover:text-white transition-colors mb-2">
              <Shirt className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 group-hover:text-black text-sm">Productos</h4>
              <p className="text-[11px] text-gray-500">Prendas y variantes</p>
            </div>
          </Link>
          ...
          <Link
            ...
            className="p-4 bg-white rounded-xl border border-gray-200 hover:border-black hover:shadow-md transition-all group flex flex-col justify-between"
          >
            <div className="p-2.5 w-fit bg-purple-50 rounded-lg text-purple-700 group-hover:bg-black group-hover:text-white transition-colors mb-2">
              <FolderTree className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 group-hover:text-black text-sm">Categorías</h4>
              <p className="text-[11px] text-gray-500">Árbol y líneas</p>
            </div>
          </Link>
          ...
          <Link
            ...
            className="p-4 bg-white rounded-xl border border-gray-200 hover:border-black hover:shadow-md transition-all group flex flex-col justify-between"
          >
            <div className="p-2.5 w-fit bg-amber-50 rounded-lg text-amber-700 group-hover:bg-black group-hover:text-white transition-colors mb-2">
              <Package className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 group-hover:text-black text-sm">Inventario</h4>
              <p className="text-[11px] text-gray-500">Stock y alertas</p>
            </div>
          </Link>
          ...
          <Link
            ...
            className="p-4 bg-white rounded-xl border border-gray-200 hover:border-black hover:shadow-md transition-all group flex flex-col justify-between"
          >
            <div className="p-2.5 w-fit bg-emerald-50 rounded-lg text-emerald-700 group-hover:bg-black group-hover:text-white transition-colors mb-2">
              <Users className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 group-hover:text-black text-sm">Usuarios</h4>
              <p className="text-[11px] text-gray-500">Roles y moderación</p>
            </div>
          </Link>
          ...
          <Link
            ...
            className="p-4 bg-white rounded-xl border border-gray-200 hover:border-black hover:shadow-md transition-all group flex flex-col justify-between"
          >
            <div className="p-2.5 w-fit bg-blue-50 rounded-lg text-blue-700 group-hover:bg-black group-hover:text-white transition-colors mb-2">
              <ImageIcon className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 group-hover:text-black text-sm">Archivos</h4>
              <p className="text-[11px] text-gray-500">Cloudinary y fotos</p>
            </div>
          </Link>
          ...
          <Link
            ...
            className="p-4 bg-white rounded-xl border border-gray-200 hover:border-black hover:shadow-md transition-all group flex flex-col justify-between"
          >
            <div className="p-2.5 w-fit bg-yellow-50 rounded-lg text-yellow-700 group-hover:bg-black group-hover:text-white transition-colors mb-2">
              <Star className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 group-hover:text-black text-sm">Reseñas</h4>
              <p className="text-[11px] text-gray-500">Moderación y spam</p>
            </div>
          </Link>
        </div>
      </div>

      {/* RESUMEN DE USUARIOS Y ACCIONES RÁPIDAS */}
